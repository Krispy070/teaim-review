...
export default function BrandedHeader({ 
  ...
  const handleUpdatesClick = () => {
    markAllSeen();
    legacyMarkAllAsSeen();
    setLocation('/audit'); // Navigate to audit page
  };
  ...
  const env = import.meta.env.VITE_ENV || (typeof window !== 'undefined' && window.location.hostname.includes("repl") ? "DEV" : "PROD");
